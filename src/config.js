...
const robotsState = path.join(__dirname, '../data/robotsState.json');
const pin = path.join(__dirname, '../data/pin.txt');
...
const brokerReportDir = path.join(__dirname, '../data/brokerReport');
